...
public class FollowPathBackwards2 extends Command {
    public Timer timer;
    public static ArrayList<Point2> leftPath, rightPath;
    ...
    protected void initialize() {
        ...
        timeOutlined = new ArrayList(TimeStepCalculator2.timeOutlined);
        heading = new ArrayList(Drivetrain.robotPath2.heading);
        heading.add(0, 0.0);
        timer = new Timer();
        timer.reset();
