...
public class SmoothPosition3 {
    ...
    public static ArrayList<Point3> pathPoints = new ArrayList<Point3>(); 
    
    public static ArrayList<Point3> newPathPoints = new ArrayList<Point3>(); 
...
//	}
    ...
    public static ArrayList<Point3> smoothPath(ArrayList<Point3> path, double a, double b, double t) {
    	for(Point3 point: path) {
    		newPathPoints.add(new Point3(point));
    	}
