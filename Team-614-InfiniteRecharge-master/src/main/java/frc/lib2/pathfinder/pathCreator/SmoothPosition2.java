...
public class SmoothPosition2 {
    ...
    public static ArrayList<Point2> pathPoints = new ArrayList<Point2>(); 
    
    public static ArrayList<Point2> newPathPoints = new ArrayList<Point2>(); 
...
//	}
    ...
    public static ArrayList<Point2> smoothPath(ArrayList<Point2> path, double a, double b, double t) {
    	for(Point2 point: path) {
    		newPathPoints.add(new Point2(point));
    	}
